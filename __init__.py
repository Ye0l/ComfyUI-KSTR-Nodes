...
from .local_prompt_nodes import NODE_CLASS_MAPPINGS as LOCAL_PROMPT_NODE_CLASS_MAPPINGS
from .local_prompt_nodes import NODE_DISPLAY_NAME_MAPPINGS as LOCAL_PROMPT_NODE_DISPLAY_NAME_MAPPINGS
